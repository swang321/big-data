package com.storm.stormredis.main;


import com.storm.stormredis.controller.CountBolt;
import com.storm.stormredis.controller.DataSourceSpout;
import com.storm.stormredis.controller.SplitBolt;
import com.storm.stormredis.controller.WordCountStoreMapper;
...
public class WordCountToRedisApp {
    ...
    private static final String REDIS_PWD = "root";
    ...
    public static void main(String[] args) {
        ...
        JedisPoolConfig poolConfig = new JedisPoolConfig.Builder()
                .setHost(REDIS_HOST).setPort(REDIS_PORT)
